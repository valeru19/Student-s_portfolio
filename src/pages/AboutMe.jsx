...
import about1 from './../img/about/combo.jpg'; // Замените на свои изображения
import about2 from './../img/about/html.png';
import about3 from './../img/about/html.png';
    ...
    return (
        <main className="section about-page" style={{ background: '#1a1a1a', color: '#fff', padding: '50px 0' }}>
            <div className="container">
                ...
                >
                <img src={about1} alt="About Me 1" style={{ width: '300px', height: '200px', objectFit: 'cover', borderRadius: '10px' }} />
                ...
                style={{ marginBottom: '50px', textAlign: 'center' }}
                >
                <img src={about2} alt="About Me 2" style={{ width: '300px', height: '200px', objectFit: 'cover', borderRadius: '10px' }} />
                ...
                <p style={{ maxWidth: '600px', margin: '20px auto' }}>
                    ...
                    >
                    <img src={about3} alt="About Me 3" style={{ width: '300px', height: '200px', objectFit: 'cover', borderRadius: '10px' }} />
